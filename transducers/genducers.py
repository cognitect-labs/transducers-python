...
Note: cgenducers.pyx should only be generated by copying this file:

some sh> cp transducers/genducers.py transducers/cgenducers.pyx

Do not change cgenducers.pyx directly at this point!
